...
def lambda_handler(
    ...
    try:
        ...
        metrics.add_metric(name="SuccessfulSettingsLookup", unit=MetricUnit.Count, value=1)
...
def _get_user_settings(table_name: str, user_id: str, namespace: Optional[str] = None) -> Dict[str, Any]:
    """
    Fetch user settings from DynamoDB
    """
    try:
