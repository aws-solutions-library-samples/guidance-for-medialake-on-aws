...
class EmbeddingStoreFactory:
    ...
    def create_embedding_store(self, store_type: Optional[str] = None) -> BaseEmbeddingStore:
        """
        ...
        if (self._cached_store is not None and 
            self._cached_setting == store_type and 
            self._cached_store.is_available()):
