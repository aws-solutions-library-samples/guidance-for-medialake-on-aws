...
class PermissionSetAssignmentRequest(BaseModel):
    ...
    permissionSetIds: List[str] = Field(..., description="List of permission set IDs to assign to the group")
...
def lambda_handler(
    ...
    try:
        ...
        logger.info("Successfully assigned permission sets to group", 
