...
Endpoints handled:
- /settings/collection-types: Collection types management (CRUD + migrate)
- Future: Other settings endpoints can be added here

All request validation is handled by Pydantic V2 models.
"""
