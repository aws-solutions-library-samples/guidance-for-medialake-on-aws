...
def handle_post_schedule(request_body: Dict[str, Any], user_email: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logger.info(f"Scheduling upgrade to {request.target_version} for {request.scheduled_time} by user: {user_email}")
