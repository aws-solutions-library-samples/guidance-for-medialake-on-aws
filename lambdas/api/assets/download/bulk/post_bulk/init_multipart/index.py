...
def update_job_multipart_info(
    user_id: str, job_id: str, upload_id: str, s3_key: str, manifest_key: str, num_parts: int, part_size: int, file_size: int
) -> None:
    """
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    ...
    try:
        ...
        update_job_multipart_info(
            user_id, job_id, upload_id, s3_key, manifest_key, len(parts), PART_SIZE, file_size
        )
