...
metrics = Metrics(namespace="BulkDownloadService", service="bulk-download-get-parts-manifest")
...
def get_parts_manifest(bucket: str, manifest_key: str, start_part: int = None, end_part: int = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if start_part is not None and end_part is not None:
            ...
            logger.info(
                ...
                extra={"manifestKey": manifest_key, "startPart": start_part, "endPart": end_part}
            )
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    ...
    try:
        ...
        parts_data = get_parts_manifest(MEDIA_ASSETS_BUCKET, manifest_key, start_part, end_part)
        
        # Add metrics
        metrics.add_metric(name="PartsManifestRetrieved", unit=MetricUnit.Count, value=1)
