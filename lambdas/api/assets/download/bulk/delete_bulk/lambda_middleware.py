    ...
    def _make_output(
        ...
        if self.is_first:
            ...
            if not (ext_id or ext_st or ext_rs):
                self.logger.info(
                    "First step with no generated external job fields - resetting to null",
                    extra={
                ...
                self.logger.info(
                    "First step with generated external job fields - preserving them",
                    extra={
                        "is_first": self.is_first,
                        "service": self.service,
                        "step_name": self.step_name,
            ...
            self.logger.info(
                "Not first step - preserving external job fields",
                extra={
                    "is_first": self.is_first,
                    "service": self.service,
                    "step_name": self.step_name,
