...
def _flatten_nested_permissions(permissions: Dict[str, Any], prefix: str = "") -> List[str]:
    """
...
def handler(event, context):
    ...
    try:
        ...
        if group_config:
            ...
            logger.info(f"Found {len(cognito_groups)} groups in Cognito token: {cognito_groups}")
