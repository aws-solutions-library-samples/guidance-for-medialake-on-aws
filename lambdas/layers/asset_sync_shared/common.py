...
class AssetProcessor:
    ...
    @staticmethod
    def format_error(error_id: str, object_key: str, error_type: str, error_message: str, 
                     retry_count: int, job_id: str, bucket_name: str) -> Dict[str, Any]:
    ...
    @staticmethod
    def check_asset_exists(asset_id: Optional[str] = None, inventory_id: Optional[str] = None) -> bool:
