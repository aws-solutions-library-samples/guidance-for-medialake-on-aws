    ...
    try:
        if request_type in ['Create', 'Update']:
            ...
            if bucket_names:
                ...
                if not table_name:
                    raise Exception("SYSTEM_SETTINGS_TABLE_NAME environment variable not set")
                ...
                print(f"Successfully stored {len(bucket_names)} MediaLake bucket names in system settings")
...
def send_response(event: Dict[str, Any], context: Any, response_status: str, response_data: Dict[str, Any]):
