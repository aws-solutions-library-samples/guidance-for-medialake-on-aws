...
def _is_pixel(value):
    return isinstance(value, numbers.Number) or (
        isinstance(value, list) and not isinstance(value, pyvips.Image)
    )
...
class Image(pyvips.VipsObject, metaclass=ImageType):
    ...
    def new_from_file(vips_filename, **kwargs):
        ...
        return pyvips.Operation.call(name, filename, string_options=options, **kwargs)
    ...
    def new_from_buffer(data, options, **kwargs):
        ...
        return pyvips.Operation.call(name, data, string_options=options, **kwargs)
    ...
    def new_from_array(cls, obj, scale=1.0, offset=0.0, interpretation=None):
        ...
        if hasattr(obj, "__array_interface__"):
            ...
            im = cls.new_from_memory(data, width, height, bands, format)
            ...
            raise TypeError("does not define __array_interface__ " "or __array__")
    ...
    def new_from_memory(data, width, height, bands, format):
        ...
        vi = vips_lib.vips_image_new_from_memory(
            pointer, nbytes, width, height, bands, format_value
        )
        if vi == ffi.NULL:
    ...
    def new_from_source(source, options, **kwargs):
        ...
        image = pyvips.Operation.call(name, source, string_options=options, **kwargs)
    ...
    def new_from_image(self, value):
        ...
        image = pixel.embed(0, 0, self.width, self.height, extend="copy")
        image = image.copy(
    ...
    def write_to_file(self, vips_filename, **kwargs):
        ...
        return pyvips.Operation.call(
            name, self, filename, string_options=options, **kwargs
        )
    ...
    def write_to_buffer(self, format_string, **kwargs):
        ...
        if pointer != ffi.NULL:
            ...
            pyvips.Operation.call(name, self, target, string_options=options, **kwargs)
            ...
            name = _to_string(pointer)
            buffer = pyvips.Operation.call(name, self, string_options=options, **kwargs)
    ...
    def write_to_target(self, target, format_string, **kwargs):
        ...
        return pyvips.Operation.call(
            name, self, target, string_options=options, **kwargs
        )
    ...
    def get(self, name):
        ...
        gv = GValue()
        result = vips_lib.vips_image_get(self.pointer, _to_bytes(name), gv.pointer)
        if result != 0:
    ...
    def set(self, name, value):
        ...
        if gtype == 0:
            raise Error(
                f"metadata item {name} does not exist -"
    ...
    def tolist(self):
        ...
        if not self.bands == 1:
            raise NotImplementedError(
                "tolist only implemented for " + "single-band images"
            )
    ...
    def __array__(self, dtype=None, copy=None):
        ...
        arr = np.frombuffer(
            self.write_to_memory(), dtype=FORMAT_TO_TYPESTR[self.format]
    ...
    def __repr__(self):
        if (
            ...
            return (
                f"<pyvips.Image {self.width}x{self.height} {self.format}, "
    ...
    def __getitem__(self, arg):
        ...
        * list of bool::
        ...
        if isinstance(arg, int):
            ...
            # is True!
            if not (
                all(type(x) == int for x in arg)  # noqa: E721
                or all(type(x) == bool for x in arg)
            ):  # noqa: E721
    ...
    def bandjoin(self, other):
        ...
        non_number = next((x for x in other if not isinstance(x, numbers.Number)), None)
    ...
    def get_n_pages(self):
        ...
        if at_least_libvips(8, 8):
            ...
            return self.get("n-pages") if self.get_typeof("n-pages") != 0 else 1
    ...
    def get_page_height(self):
        ...
        if at_least_libvips(8, 8):
            ...
            if (
                page_height > 0
                and page_height <= self.height
                and self.height % page_height == 0
            ):
                return page_height
            else:
                return self.height
    ...
    def pagesplit(self):
        ...
        return [
            self.crop(0, y, self.width, page_height)
