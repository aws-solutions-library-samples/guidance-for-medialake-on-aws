...
from pyvips import Error, _to_bytes, _to_string, ffi, glib_lib, gobject_lib, vips_lib
...
def values_for_enum(gtype):
    ...
    return [
        _to_string(g_enum_class.values[i].value_nick)
...
def values_for_flag(gtype):
    ...
    return [
        _to_string(g_flags_class.values[i].value_nick)
...
def enum_dict(gtype):
    ...
    return {
        _to_string(g_enum_class.values[i].value_nick): g_enum_class.values[i].value
        for i in range(g_enum_class.n_values)
    }
...
def flags_dict(gtype):
    ...
    return {
        _to_string(g_flags_class.values[i].value_nick): g_flags_class.values[i].value
        for i in range(g_flags_class.n_values)
    }
