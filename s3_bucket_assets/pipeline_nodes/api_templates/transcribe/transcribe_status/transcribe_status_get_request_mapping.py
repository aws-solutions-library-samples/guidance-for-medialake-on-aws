        ...
        if not job_name:
            ...
            if "data" in payload and isinstance(payload["data"].get("body"), str):
                try:
                    ...
                    if "transcription" in data_body and "job_name" in data_body["transcription"]:
                        job_name = data_body["transcription"]["job_name"]
                except (json.JSONDecodeError, KeyError):
                    pass
        
        if not job_name:
            raise KeyError("Missing 'job_name' in payload.body.transcription and not found in metadata")
