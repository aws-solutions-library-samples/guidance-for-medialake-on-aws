def translate_event_to_request(event):
    ...
    try:
        ...
        print(f"Final values - s3_bucket: {s3_bucket}, s3_key: {s3_key}, s3_path: {s3_path}")
        print(f"media_format: {media_format}, output_bucket: {output_bucket}, transcribe_role_arn: {transcribe_role_arn}")
