...
- Enable and configure semantic search providers (e.g., TwelveLabs) as described in the UI and [`MediaLake-Installation-Guide.md`](assets/docs/MediaLake-Installation-Guide.md).
