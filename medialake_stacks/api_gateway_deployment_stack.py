from aws_cdk import Stack, Environment, aws_wafv2 as wafv2, aws_ssm as ssm, CfnOutput, Fn, CustomResource
...
class ApiGatewayDeploymentStackProps:
    ...
    api_dependencies: list = None  # Optional list of dependencies to ensure all API resources are created before deployment

class ApiGatewayDeploymentStack(Stack):
    def __init__(self, scope: Construct, id: str, props: ApiGatewayDeploymentStackProps, **kwargs):
...
def handler(event, context):
    ...
    try:
        ...
        cr.Provider(
            ...
            on_event_handler=deployment_function
        )
