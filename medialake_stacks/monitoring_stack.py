...
class MonitoringStack(Stack):
    ...
    def _get_lambda_functions_with_prefix(self, resource_prefix: str) -> List[str]:
        ...
        for construct in self.node.scoped_children:
            if isinstance(construct, lambda_.Function) and construct.function_name.startswith(resource_prefix):
        ...
        if not lambda_functions:
            ...
            print("No Lambda functions found in current stack. In a real implementation, "
            ...
            lambda_functions = [f"{resource_prefix}-function1", f"{resource_prefix}-function2"]
