    ...
    <Container maxWidth="lg">
      <Paper sx={{ p: 4, mt: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          This demo showcases an Uppy 5.0 with unified Dashboard experience and built-in progress
          tracking for dynamic S3 connector selection and presigned URL generation.
        </Typography>
        <Typography variant="body1" paragraph>
          Features:
        </Typography>
        <Box component="ul">
          ...
          <Box component="li">
            <Typography>
              Content type restriction to audio/*, video/*, image/*, HLS, and MPEG-DASH
            </Typography>
          </Box>
          <Box component="li">
            <Typography>
              Automatic multipart upload for files larger than 100MB with dynamic part size (5MB
              default, auto-adjusts for files exceeding 10,000 parts)
            </Typography>
          </Box>
          <Box component="li">
          ...
          <Box component="li">
            <Typography>
              Built-in progress UI with upload status, speed, and ETA (powered by Uppy 5.0
              Dashboard)
            </Typography>
          </Box>
        </Box>
