...
import type { Integration, IntegrationFormData, IntegrationsError } from '../types/integrations.types';
...
export const useCreateIntegration = () => {
    ...
    return useMutation({
        mutationFn: (data: IntegrationFormData) => {
            ...
            return integrationsController.createIntegration(data).then(result => {
