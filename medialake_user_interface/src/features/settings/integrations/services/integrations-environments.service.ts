import { useEnvironments, useEnvironment } from '@/features/settings/environments/api/environmentsController';
import { Environment, EnvironmentError } from '@/features/settings/environments/types/environments.types';
...
export class IntegrationsEnvironmentsService {
    ...
    public static getEnvironmentById(environments: Environment[], environmentId: string): Environment | undefined {
