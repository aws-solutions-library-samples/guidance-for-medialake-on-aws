      ...
      <DialogContent>
        <Box sx={{ mb: 3 }}>
          <Typography variant="body1" paragraph>
            Some nodes in the imported pipeline reference integrations that don't exist in this environment.
            Please select replacement integrations for each node:
          </Typography>
                ...
                <TableRow key={node.nodeId}>
                  ...
                  <TableCell>
                    <FormControl fullWidth>
                      ...
                      <Select
                        value={mappings.find(m => m.nodeIndex === node.nodeIndex)?.newIntegrationId || ''}
                        onChange={(e) => handleIntegrationChange(node.nodeIndex, e.target.value as string)}
