...
const sampleCollections: Collection[] = [
    {
        ...
        description: 'Marketing assets for the upcoming summer campaign including photos and videos from the beach photoshoot.',
        itemCount: 124,
    ...
    },
    {
        ...
        description: 'All media assets related to new product launches, including promotional materials and product photos.',
        itemCount: 89,
    ...
    },
    {
        ...
        description: 'Curated collection of images and videos optimized for various social media platforms.',
