...
export const API_ENDPOINTS = {
  ...
  PORTALS: {
    ...
    GET: (id: string) => `/settings/portals/${id}`,
    UPDATE: (id: string) => `/settings/portals/${id}`,
    DELETE: (id: string) => `/settings/portals/${id}`,
    LOGO: (id: string) => `/settings/portals/${id}/logo`,
    BANNER: (id: string) => `/settings/portals/${id}/banner`,
