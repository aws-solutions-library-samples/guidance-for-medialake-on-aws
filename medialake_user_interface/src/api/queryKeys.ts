export const QUERY_KEYS = {
    ...
    SEARCH: {
        ...
        list: (query: string, page: number, pageSize: number, isSemantic: boolean, facetParams?: Record<string, any>) =>
            [...QUERY_KEYS.SEARCH.lists(), { query, page, pageSize, isSemantic, facetParams }] as const,
    },
    ASSETS: {
        all: ['assets'] as const,
