export default {
  ...
  collections: {
    ...
    thumbnail: {
      ...
      fileTooLarge: "이미지는 5MB 미만이어야 합니다",
    },
  },
  collectionsPage: {
    title: "컬렉션",
  ...
  shareDialog: {
    title: "자산 공유",
    selectVersion: "공유할 버전 선택",
    proxy: "프록시 (웹 최적화)",
    proxyDescription: "더 빠른 로딩",
    proxyOptimized: "스트리밍 최적화",
    proxyBandwidth: "낮은 대역폭",
    recommended: "권장",
    original: "원본 (전체 품질)",
    originalQuality: "최고 품질",
    originalResolution: "원본 해상도",
    originalSize: "더 큰 파일 크기",
    expiration: "만료",
    expirationOptions: {
  ...
  publicShare: {
    ...
    media: {
      ...
      previewNotAvailableFormat:
        "이 파일 유형은 미리보기를 사용할 수 없습니다. 파일을 다운로드하여 볼 수 있습니다.",
    },
    error: {
      notFound: "공유를 찾을 수 없거나 만료되었습니다",
      notFoundMessage:
        "이 공유 링크가 해지되었거나 만료되었을 수 있습니다. 이 링크를 공유한 사람에게 문의하세요.",
    },
  },
  dashboard: {
    widgets: {
