export default {
  ...
  common: {
    ...
    batchOperations: {
      ...
      workflow: "워크플로",
      collection: "컬렉션",
      recentWorkflows: "최근 워크플로",
      allWorkflows: "모든 워크플로…",
      recentCollections: "최근 컬렉션",
      noRecentCollections: "최근 컬렉션이 없습니다",
      allCollections: "모든 컬렉션…",
      itemsSelected: "{{count}}개 선택됨",
      addedToCollection: "{{count}}개를 {{name}}에 추가했습니다",
      alreadyInCollection: "{{count}}개는 이미 {{name}}에 있습니다",
      workflowPicker: {
        title: "워크플로 실행",
        search: "워크플로 검색...",
        noResults: "검색과 일치하는 워크플로가 없습니다",
        run: "실행",
        created: "생성일 {{date}}",
      },
