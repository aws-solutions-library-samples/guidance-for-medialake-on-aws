export default {
    ...
    settings: {
      ...
      systemSettings: {
        ...
        search: {
          ...
          description: 'Configurez le fournisseur de recherche pour améliorer les capacités de recherche de vos actifs multimédias.',
    ...
    translation: {
      ...
      home: {
        welcome: 'Bienvenue sur MediaLake',
        ...
        editor: {
          ...
          modals: {
            ...
            delete: {
              ...
              message: 'Êtes-vous sûr de vouloir supprimer ce pipeline ? Cette action est irréversible.',
