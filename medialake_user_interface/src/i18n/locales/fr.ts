export default {
  ...
  common: {
    ...
    batchOperations: {
      ...
      recentWorkflows: "Flux de travail récents",
      allWorkflows: "Tous les flux de travail…",
      recentCollections: "Collections récentes",
      noRecentCollections: "Aucune collection récente",
      allCollections: "Toutes les collections…",
      itemsSelected: "{{count}} sélectionné(s)",
      addedToCollection: "{{count}} ajouté(s) à {{name}}",
      alreadyInCollection: "{{count}} déjà dans {{name}}",
      workflowPicker: {
        title: "Exécuter le flux de travail",
        search: "Rechercher des flux de travail...",
        noResults: "Aucun flux de travail ne correspond à votre recherche",
        run: "Exécuter",
