export default {
  ...
  collections: {
    ...
    thumbnail: {
      ...
      fileTooLarge: "L'image doit faire moins de 5 Mo",
    },
  },
  collectionsPage: {
    title: "Collections",
  ...
  shareDialog: {
    title: "Partager l'actif",
    selectVersion: "Sélectionner la version à partager",
    proxy: "Proxy (optimisé pour le web)",
    proxyDescription: "Chargement plus rapide",
    proxyOptimized: "Optimisé pour la diffusion en continu",
    proxyBandwidth: "Bande passante réduite",
    recommended: "Recommandé",
    original: "Original (qualité complète)",
    originalQuality: "Qualité maximale",
    originalResolution: "Résolution d'origine",
    originalSize: "Taille de fichier plus grande",
    ...
    revokeShare: "Révoquer le partage",
    noShares: "Aucun partage créé pour l'instant",
    close: "Fermer",
    createShareLink: "Créer un lien de partage",
  },
  publicShare: {
    title: "Actif partagé",
    assetMetadata: "Métadonnées d'actif",
    poweredBy: "Powered by MediaLake",
    downloadFile: "Télécharger le fichier",
    generatingDownload: "Génération du téléchargement...",
    representationType: {
      webOptimized: "Optimisé pour le web",
    ...
    media: {
      ...
      previewNotAvailableFormat:
        "L'aperçu n'est pas disponible pour ce type de fichier. Vous pouvez télécharger le fichier pour l'afficher.",
    },
    error: {
      notFound: "Partage non trouvé ou expiré",
      notFoundMessage:
        "Ce lien de partage a peut-être été révoqué ou a expiré. Veuillez contacter la personne qui a partagé ce lien avec vous.",
    },
  },
  dashboard: {
    widgets: {
