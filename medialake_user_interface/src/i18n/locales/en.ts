export default {
  ...
  shareDialog: {
    title: "Share Asset",
    selectVersion: "Select Version to Share",
    proxy: "Proxy (Web-Optimized)",
    proxyDescription: "Faster loading",
    proxyOptimized: "Optimized for streaming",
    proxyBandwidth: "Lower bandwidth",
    recommended: "Recommended",
    original: "Original (Full Quality)",
    originalQuality: "Highest quality",
    originalResolution: "Original resolution",
    originalSize: "Larger file size",
  ...
  publicShare: {
    ...
    generatingDownload: "Generating Download...",
    representationType: {
    ...
    error: {
      ...
      notFoundMessage:
        "This share link may have been revoked or expired. Please contact the person who shared this link with you.",
    },
  },
  dashboard: {
    widgets: {
