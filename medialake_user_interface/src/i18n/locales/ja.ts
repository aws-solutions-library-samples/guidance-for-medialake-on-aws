export default {
  ...
  collections: {
    ...
    thumbnail: {
      ...
      fileTooLarge: "画像は5MB未満である必要があります",
    },
  },
  collectionsPage: {
    title: "コレクション",
  ...
  shareDialog: {
    title: "アセットを共有",
    selectVersion: "共有するバージョンを選択",
    proxy: "プロキシ (Web最適化)",
    proxyDescription: "読み込みが高速",
    proxyOptimized: "ストリーミング向けに最適化",
    proxyBandwidth: "低帯域幅",
    recommended: "推奨",
    original: "オリジナル (フルクオリティ)",
    originalQuality: "最高品質",
    originalResolution: "オリジナル解像度",
    originalSize: "ファイルサイズが大きい",
    expiration: "有効期限",
    expirationOptions: {
  ...
  publicShare: {
    title: "共有アセット",
    assetMetadata: "アセットメタデータ",
    poweredBy: "MediaLake により提供",
    downloadFile: "ファイルをダウンロード",
    generatingDownload: "ダウンロードを生成中...",
    representationType: {
      webOptimized: "ウェブ最適化",
    ...
    media: {
      ...
      previewNotAvailableFormat:
        "このファイル形式はプレビューできません。ファイルをダウンロードして表示してください。",
    },
    error: {
      notFound: "共有が見つからないか、期限切れです",
      notFoundMessage:
        "この共有リンクは取り消されたか、期限が切れている可能性があります。このリンクを共有した人に連絡してください。",
    },
  },
  dashboard: {
    widgets: {
