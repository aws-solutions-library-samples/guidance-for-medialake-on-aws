export default {
    ...
    assetExplorer: {
        ...
        noIndexedAssets: 'バケット "{{bucketName}}" のこのコネクタのインデックス化されたアセットが見つかりません。',
    ...
    translation: {
      ...
      notifications: {
        ...
        'Asset processing pipeline completed successfully': 'アセット処理パイプラインが正常に完了しました',
      ...
      integrations: {
        ...
        deleteConfirmation: {
          title: '統合を削除',
          message: 'この統合を削除してもよろしいですか？',
          warning: '警告: この統合を削除すると、それを使用するパイプラインが破損する可能性があります。'
        },
        form: {
          title: '統合を追加',
          fields: {
