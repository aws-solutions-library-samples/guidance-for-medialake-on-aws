export default {
  ...
  collectionsPage: {
    ...
    itemsBeingAdded: "Itens sendo adicionados",
  ...
  common: {
    ...
    batchOperations: {
      ...
      collection: "Coleção",
      recentWorkflows: "Fluxos de trabalho recentes",
      allWorkflows: "Todos os fluxos de trabalho…",
      recentCollections: "Coleções recentes",
      noRecentCollections: "Nenhuma coleção recente",
      allCollections: "Todas as coleções…",
      itemsSelected: "{{count}} selecionado(s)",
      addedToCollection: "{{count}} adicionado(s) a {{name}}",
      alreadyInCollection: "{{count}} já em {{name}}",
      workflowPicker: {
        title: "Executar fluxo de trabalho",
        search: "Pesquisar fluxos de trabalho...",
        noResults: "Nenhum fluxo de trabalho corresponde à sua pesquisa",
        run: "Executar",
  ...
  detailPages: {
    player: {
      previewUnavailableTitle: "Pré-visualização ainda não disponível",
      previewUnavailableBody:
        "Ainda não foi gerado um proxy reproduzível para este ativo. Se o pipeline de ingestão ainda estiver em execução, a pré-visualização aparecerá aqui quando terminar.",
    },
    tabs: {
      summary: "Resumo",
