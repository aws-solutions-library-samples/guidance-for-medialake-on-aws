export default {
  ...
  collections: {
    ...
    thumbnail: {
      ...
      fileTooLarge: "A imagem deve ter menos de 5MB",
    },
  },
  collectionsPage: {
    title: "Coleções",
  ...
  shareDialog: {
    ...
    selectVersion: "Selecionar versão para compartilhar",
    proxy: "Proxy (otimizado para web)",
    proxyDescription: "Carregamento mais rápido",
    proxyOptimized: "Otimizado para streaming",
    proxyBandwidth: "Menor largura de banda",
    recommended: "Recomendado",
    original: "Original (qualidade completa)",
    originalQuality: "Qualidade máxima",
    originalResolution: "Resolução original",
    originalSize: "Tamanho de arquivo maior",
    ...
    allowEmbedding: "Permitir incorporação",
    existingShares: "Compartilhamentos existentes",
    created: "Criado",
    expires: "Expira",
    expired: "Expirado",
  ...
  publicShare: {
    title: "Ativo compartilhado",
    assetMetadata: "Metadados de ativo",
    poweredBy: "Powered by MediaLake",
    downloadFile: "Baixar arquivo",
    generatingDownload: "Gerando download...",
    representationType: {
      webOptimized: "Otimizado para web",
      originalQuality: "Qualidade original",
    },
    expiry: "Expira",
    embed: {
      title: "Incorporar este ativo",
      description: "Copie e compartilhe este link para incorporar o ativo:",
      copyLink: "Copiar link",
      linkCopied: "Link copiado para a área de transferência",
    },
    media: {
      previewNotAvailable: "A visualização de mídia não está disponível no momento.",
      previewNotAvailableFormat:
        "A visualização não está disponível para este tipo de arquivo. Você pode baixar o arquivo para visualizá-lo.",
    },
    error: {
      notFound: "Compartilhamento não encontrado ou expirado",
      notFoundMessage:
        "Este link de compartilhamento pode ter sido revogado ou expirado. Entre em contato com a pessoa que compartilhou este link com você.",
    },
  },
  dashboard: {
    widgets: {
