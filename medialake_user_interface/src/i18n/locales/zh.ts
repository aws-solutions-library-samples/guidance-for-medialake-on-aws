export default {
  ...
  shareDialog: {
    title: "共享资产",
    selectVersion: "选择要共享的版本",
    proxy: "代理（网络优化）",
    proxyDescription: "加载速度更快",
    proxyOptimized: "针对流媒体优化",
    proxyBandwidth: "更低的带宽",
    recommended: "推荐",
    original: "原始（完整质量）",
    originalQuality: "最高质量",
  ...
  publicShare: {
    ...
    error: {
      notFound: "未找到共享或已过期",
      notFoundMessage: "此共享链接可能已被撤销或已过期。请联系与您共享此链接的人。",
    },
  },
  dashboard: {
    widgets: {
