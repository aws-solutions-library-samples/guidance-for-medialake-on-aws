export default {
  ...
  common: {
    ...
    batchOperations: {
      ...
      workflow: "工作流",
      collection: "收藏集",
      recentWorkflows: "最近的工作流",
      allWorkflows: "所有工作流…",
      recentCollections: "最近的收藏集",
      noRecentCollections: "没有最近使用的收藏集",
      allCollections: "所有收藏集…",
      itemsSelected: "已选择 {{count}} 项",
      addedToCollection: "已将 {{count}} 项添加到 {{name}}",
      alreadyInCollection: "{{count}} 项已在 {{name}} 中",
      workflowPicker: {
        title: "运行工作流",
        search: "搜索工作流...",
        noResults: "没有工作流与您的搜索匹配",
        run: "运行",
        created: "创建于 {{date}}",
      },
      deleteSelected: "删除所选",
