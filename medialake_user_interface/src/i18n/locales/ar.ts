export default {
  ...
  common: {
    ...
    batchOperations: {
      ...
      allWorkflows: "كل عمليات سير العمل…",
      recentCollections: "المجموعات الأخيرة",
      noRecentCollections: "لا توجد مجموعات حديثة",
      allCollections: "كل المجموعات…",
      itemsSelected: "{{count}} محدد",
      addedToCollection: "تمت إضافة {{count}} إلى {{name}}",
      alreadyInCollection: "{{count}} موجود بالفعل في {{name}}",
      workflowPicker: {
        title: "تشغيل سير العمل",
        search: "بحث في سير العمل...",
        noResults: "لا يوجد سير عمل يطابق بحثك",
        run: "تشغيل",
