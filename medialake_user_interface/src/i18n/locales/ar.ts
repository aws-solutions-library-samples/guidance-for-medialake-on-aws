export default {
  ...
  collections: {
    ...
    thumbnail: {
      ...
      fileTooLarge: "يجب أن تكون الصورة أقل من 5 ميجابايت",
    },
  },
  collectionsPage: {
    title: "المجموعات",
  ...
  shareDialog: {
    title: "مشاركة الأصل",
    selectVersion: "اختر النسخة المراد مشاركتها",
    proxy: "الوكيل (محسّن للويب)",
    proxyDescription: "تحميل أسرع",
    proxyOptimized: "محسّن للبث",
    proxyBandwidth: "عرض نطاق أقل",
    recommended: "موصى به",
    original: "الأصل (جودة عالية)",
    originalQuality: "أعلى جودة",
    originalResolution: "الدقة الأصلية",
    originalSize: "حجم ملف أكبر",
  ...
  publicShare: {
    title: "الأصل المشارك",
    assetMetadata: "بيانات تعريف الأصل",
    poweredBy: "مدعوم من MediaLake",
    downloadFile: "تحميل الملف",
    generatingDownload: "جارٍ إنشاء التحميل...",
    representationType: {
      webOptimized: "مُحسَّن للويب",
    ...
    error: {
      notFound: "لم يتم العثور على المشاركة أو انتهت صلاحيتها",
      notFoundMessage:
        "قد تكون هذه رابط المشاركة قد تم إلغاء مشاركتها أو انتهت صلاحيتها. يرجى الاتصال بالشخص الذي شارك هذا الرابط معك.",
    },
  },
  dashboard: {
    widgets: {
