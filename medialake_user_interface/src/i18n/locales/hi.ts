export default {
  ...
  collections: {
    ...
    thumbnail: {
      ...
      fileTooLarge: "छवि 5MB से कम होनी चाहिए",
    },
  },
  collectionsPage: {
    title: "कलेक्शन",
  ...
  shareDialog: {
    ...
    selectVersion: "साझा करने के लिए संस्करण चुनें",
    proxy: "प्रॉक्सी (वेब-अनुकूलित)",
    proxyDescription: "तेज़ लोडिंग",
    proxyOptimized: "स्ट्रीमिंग के लिए अनुकूलित",
    proxyBandwidth: "कम बैंडविड्थ",
    recommended: "अनुशंसित",
    original: "मूल (पूर्ण गुणवत्ता)",
    originalQuality: "सर्वोच्च गुणवत्ता",
    originalResolution: "मूल संकल्प",
    originalSize: "बड़ी फ़ाइल आकार",
    expiration: "समाप्ति",
    expirationOptions: {
    ...
    expires: "समाप्ति",
    expired: "समाप्त",
    accessCount: "पहुंच गणना",
    downloadCount: "डाउनलोड गणना",
    copyUrl: "URL कॉपी करें",
    revokeShare: "साझाकरण रद्द करें",
    noShares: "अभी तक कोई साझाकरण नहीं बनाया गया है",
    close: "बंद करें",
    createShareLink: "साझाकरण लिंक बनाएं",
  },
  publicShare: {
    title: "साझा संपत्ति",
    assetMetadata: "संपत्ति मेटाडेटा",
    poweredBy: "Powered by MediaLake",
    downloadFile: "फ़ाइल डाउनलोड करें",
    generatingDownload: "डाउनलोड जेनरेट किया जा रहा है...",
    representationType: {
      webOptimized: "वेब-अनुकूलित",
    ...
    media: {
      ...
      previewNotAvailableFormat:
        "इस फ़ाइल प्रकार के लिए पूर्वावलोकन उपलब्ध नहीं है। आप इसे देखने के लिए फ़ाइल डाउनलोड कर सकते हैं।",
    },
    error: {
      notFound: "साझाकरण नहीं मिला या समाप्त हो गया",
      notFoundMessage:
        "यह साझाकरण लिंक रद्द किया जा सकता है या समाप्त हो सकता है। कृपया उस व्यक्ति से संपर्क करें जिसने यह लिंक आपके साथ साझा किया था।",
    },
  },
  dashboard: {
    widgets: {
