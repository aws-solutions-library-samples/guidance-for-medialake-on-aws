export default {
  ...
  common: {
    ...
    batchOperations: {
      ...
      workflow: "वर्कफ़्लो",
      collection: "संग्रह",
      recentWorkflows: "हाल के वर्कफ़्लो",
      allWorkflows: "सभी वर्कफ़्लो…",
      recentCollections: "हाल के संग्रह",
      noRecentCollections: "कोई हाल का संग्रह नहीं",
      allCollections: "सभी संग्रह…",
      itemsSelected: "{{count}} चयनित",
      addedToCollection: "{{count}} को {{name}} में जोड़ा गया",
      alreadyInCollection: "{{count}} पहले से {{name}} में है",
      workflowPicker: {
        title: "वर्कफ़्लो चलाएँ",
        search: "वर्कफ़्लो खोजें...",
        noResults: "आपकी खोज से कोई वर्कफ़्लो मेल नहीं खाता",
        run: "चलाएँ",
