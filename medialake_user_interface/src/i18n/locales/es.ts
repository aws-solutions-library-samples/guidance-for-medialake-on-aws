export default {
    ...
    assetExplorer: {
        ...
        noIndexedAssets: 'No se encontraron activos indexados para este conector con el bucket "{{bucketName}}".',
        ...
        deleteDialog: {
          ...
          description: '¿Estás seguro de que quieres eliminar este activo? Esta acción no se puede deshacer.',
          cancel: 'Cancelar',
          confirm: 'Eliminar'
        }
    },
    home: {
        title: 'Inicio',
        description: 'MediaLake - Un lago de datos para tus medios y metadatos',
    ...
    integrations: {
      ...
      deleteConfirmation: {
        ...
        warning: 'Precaución: Eliminar esta integración puede causar que fallen los pipelines que dependen de ella.'
      },
      form: {
        search: {
    ...
    settings: {
      ...
      systemSettings: {
        ...
        search: {
          ...
          description: 'Configura el proveedor de búsqueda para capacidades de búsqueda mejoradas en tus activos multimedia.',
    ...
    translation: {
      ...
      home: {
        welcome: 'Bienvenido a MediaLake',
      ...
      notifications: {
        ...
        'Asset processing pipeline completed successfully': 'El pipeline de procesamiento de activos se completó exitosamente',
      ...
      metadata: {
        title: 'Próximamente',
        description: "Estamos trabajando para traerte capacidades de gestión de metadatos. ¡Mantente atento!"
      },
      pipelines: {
        title: 'Pipelines',
        description: 'Gestiona tus pipelines de medios y metadatos',
        ...
        editor: {
          ...
          modals: {
            error: {
              title: 'Error',
              incompatibleNodes: 'La salida del nodo anterior no es compatible con la entrada del nodo de destino.',
              validation: 'La validación del pipeline falló'
            },
            delete: {
              title: 'Eliminar pipeline',
              message: '¿Estás seguro de que quieres eliminar este pipeline? Esta acción no se puede deshacer.',
      ...
      integrations: {
        ...
        deleteConfirmation: {
          title: 'Eliminar integración',
          message: '¿Estás seguro de que quieres eliminar esta integración?',
          warning: 'Advertencia: Eliminar esta integración puede romper pipelines que la están usando.'
        },
        form: {
          title: 'Agregar integración',
          fields: {
