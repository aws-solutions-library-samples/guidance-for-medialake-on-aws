export default {
  ...
  collectionsPage: {
    ...
    itemsBeingAdded: "Elementos que se van a añadir",
  ...
  common: {
    ...
    batchOperations: {
      ...
      recentWorkflows: "Flujos de trabajo recientes",
      allWorkflows: "Todos los flujos de trabajo…",
      recentCollections: "Colecciones recientes",
      noRecentCollections: "No hay colecciones recientes",
      allCollections: "Todas las colecciones…",
      itemsSelected: "{{count}} seleccionados",
      addedToCollection: "Se añadieron {{count}} a {{name}}",
      alreadyInCollection: "{{count}} ya en {{name}}",
      workflowPicker: {
        title: "Ejecutar flujo de trabajo",
        search: "Buscar flujos de trabajo...",
        noResults: "Ningún flujo de trabajo coincide con su búsqueda",
        run: "Ejecutar",
        created: "Creado {{date}}",
      },
  ...
  detailPages: {
    player: {
      previewUnavailableTitle: "Vista previa aún no disponible",
      previewUnavailableBody:
        "Todavía no se ha generado un proxy reproducible para este activo. Si su canalización de ingesta sigue en curso, la vista previa aparecerá aquí cuando termine.",
    },
    tabs: {
      summary: "Resumen",
