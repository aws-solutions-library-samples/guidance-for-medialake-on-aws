export default {
  ...
  collections: {
    ...
    thumbnail: {
      ...
      fileTooLarge: "התמונה חייבת להיות קטנה מ-5MB",
    },
  },
  collectionsPage: {
    title: "אוספים",
  ...
  shareDialog: {
    title: "שתף נכס",
    selectVersion: "בחר גרסה לשיתוף",
    proxy: "כתובת חילוף (מאופטימל לאינטרנט)",
    proxyDescription: "טעינה מהירה יותר",
    proxyOptimized: "מאופטימל לסטרימינג",
    proxyBandwidth: "רוחב פס נמוך יותר",
    recommended: "מומלץ",
    original: "מקור (איכות מלאה)",
    originalQuality: "איכות גבוהה ביותר",
    originalResolution: "רזולוציה מקורית",
    originalSize: "גודל קובץ גדול יותר",
    expiration: "פקיעה",
    expirationOptions: {
    ...
    downloadCount: "ספירת הורדות",
    copyUrl: "העתק URL",
    revokeShare: "בטל שיתוף",
    noShares: "עדיין לא נוצרו שיתופים",
    close: "סגור",
    createShareLink: "צור קישור שיתוף",
  },
  publicShare: {
    title: "נכס משותף",
    assetMetadata: "מטא-נתונים של נכסים",
    poweredBy: "Powered by MediaLake",
    downloadFile: "הורד קובץ",
    generatingDownload: "מייצר הורדה...",
    representationType: {
      webOptimized: "מיטוב אינטרנט",
    ...
    media: {
      ...
      previewNotAvailableFormat:
        "תצוגה מקדימה אינה זמינה לסוג קובץ זה. אתה יכול להוריד את הקובץ כדי להציג אותו.",
    },
    error: {
      notFound: "השיתוף לא נמצא או פג תוקף",
      notFoundMessage:
        "ייתכן שקישור שיתוף זה בוטל או פג תוקף. אנא צור קשר עם האדם שחלק קישור זה איתך.",
    },
  },
  dashboard: {
    widgets: {
