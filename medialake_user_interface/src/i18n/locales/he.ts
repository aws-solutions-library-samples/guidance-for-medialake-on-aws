export default {
  ...
  common: {
    ...
    batchOperations: {
      ...
      collection: "אוסף",
      recentWorkflows: "תהליכי עבודה אחרונים",
      allWorkflows: "כל תהליכי העבודה…",
      recentCollections: "אוספים אחרונים",
      noRecentCollections: "אין אוספים אחרונים",
      allCollections: "כל האוספים…",
      itemsSelected: "{{count}} נבחרו",
      addedToCollection: "{{count}} נוספו ל{{name}}",
      alreadyInCollection: "{{count}} כבר ב{{name}}",
      workflowPicker: {
        title: "הפעלת תהליך עבודה",
        search: "חיפוש תהליכי עבודה...",
        noResults: "אין תהליכי עבודה שתואמים את החיפוש",
        run: "הפעל",
        created: "נוצר {{date}}",
      },
