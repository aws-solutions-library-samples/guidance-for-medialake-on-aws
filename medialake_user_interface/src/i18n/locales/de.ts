export default {
  ...
  shareDialog: {
    title: "Vermögenswert freigeben",
    selectVersion: "Freizugebende Version auswählen",
    proxy: "Proxy (Web-optimiert)",
    proxyDescription: "Schnelleres Laden",
    proxyOptimized: "Für Streaming optimiert",
    proxyBandwidth: "Niedrigere Bandbreite",
    recommended: "Empfohlen",
    original: "Original (Vollqualität)",
    originalQuality: "Höchste Qualität",
    originalResolution: "Originalauflösung",
    originalSize: "Größere Dateigröße",
    expiration: "Ablauf",
    expirationOptions: {
    ...
    expires: "Ablauf",
    expired: "Abgelaufen",
    accessCount: "Zugriffszahl",
    downloadCount: "Download-Zahl",
    copyUrl: "URL kopieren",
    revokeShare: "Freigabe widerrufen",
    noShares: "Noch keine Freigaben erstellt",
    close: "Schließen",
    createShareLink: "Freigabelink erstellen",
  },
  publicShare: {
    title: "Gemeinsam genutzter Vermögenswert",
    assetMetadata: "Vermögensmetadaten",
    poweredBy: "Powered by MediaLake",
    downloadFile: "Datei herunterladen",
    generatingDownload: "Download wird generiert...",
    representationType: {
    ...
    media: {
      ...
      previewNotAvailableFormat:
        "Vorschau für diesen Dateityp nicht verfügbar. Sie können die Datei herunterladen, um sie anzuzeigen.",
    },
    error: {
      notFound: "Freigabe nicht gefunden oder abgelaufen",
      notFoundMessage:
        "Dieser Freigabe-Link wurde möglicherweise widerrufen oder ist abgelaufen. Bitte kontaktieren Sie die Person, die diesen Link mit Ihnen geteilt hat.",
    },
  },
  dashboard: {
    widgets: {
