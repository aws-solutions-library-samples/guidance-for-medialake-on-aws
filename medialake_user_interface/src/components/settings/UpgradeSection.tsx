...
export const UpgradeSection: React.FC = () => {
  ...
  const [versions, setVersions] = useState<{ branches: Version[]; tags: Version[] } | null>(null);
          ...
          {status?.active_upgrade && (
            <Box sx={{ mt: 3 }}>
              ...
              <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: 'block' }}>
                {status.active_upgrade.progress.stage}: {status.active_upgrade.progress.current_action}
              </Typography>
            </Box>
          )}
          ...
          <CardContent>
            {versions && versions.branches && versions.tags ? (
              ...
              <Typography variant="body2" color="text.secondary" sx={{ p: 2, textAlign: 'center' }}>
                {t('settings.systemSettings.upgrade.loadingVersions', 'Loading available versions...')}
              </Typography>
            )}
          </CardContent>
        </TabPanel>
