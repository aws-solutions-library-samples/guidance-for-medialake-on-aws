...
import { fetchVideos, fetchImages, fetchAudios } from '../mediaService';

const MediaCard = ({ type, src, id, fileName, creationDate, description }) => {
...
const SearchResults = () => {
    ...
    const videos = [
        ...
        // { src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', id: 7, fileName: 'For Bigger Fun', creationDate: '2023-05-07T14:00:00Z', description: 'Introducing Chromecast. The easiest way to enjoy online video and music on your TV' },
        // { src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4', id: 8, fileName: 'For Bigger Joyrides', creationDate: '2023-05-08T15:30:00Z', description: 'Introducing Chromecast. The easiest way to enjoy online video and music on your TV' },
        // { src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', id: 9, fileName: 'For Bigger Meltdowns', creationDate: '2023-05-09T13:15:00Z', description: 'Introducing Chromecast. The easiest way to enjoy online video and music on your TV' },
    ];
