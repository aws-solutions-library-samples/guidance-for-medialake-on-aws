                ...
                >
                    <IconButton
                        ...
                        sx={{
                            ...
                            color: mode === 'light' ? muiTheme.palette.primary.main : muiTheme.palette.text.secondary,
                        }}
                    >
                        <LightIcon fontSize="small" />
                    </IconButton>
                    <IconButton
                        ...
                        sx={{
                            ...
                            color: mode === 'dark' ? muiTheme.palette.primary.main : muiTheme.palette.text.secondary,
                        }}
                    >
                        <DarkIcon fontSize="small" />
                    </IconButton>
                    <IconButton
                        ...
                        sx={{
                            ...
                            color: mode === 'system' ? muiTheme.palette.primary.main : muiTheme.palette.text.secondary,
                        }}
                    >
