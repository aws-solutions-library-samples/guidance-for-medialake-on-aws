...
class OpenSearchServerlessProps:
    ...
    collection_desc: str = "Collection to be used for vector search using OpenSearch Serverless"
    ...
    def __init__(
        ...
        network_security_policy = json.dumps([{
            "Rules": [
                {
                "Resource": [
                    f"collection/{self.props.collection_name}"
                ],
        ...
        self.cfn_network_security_policy = opensearch_serverless.CfnSecurityPolicy(self, "NetworkSecurityPolicy",
        ...
        encryption_security_policy_name = f"{self.props.collection_name}-security-policy"
        assert len(encryption_security_policy_name) <= 32, f"Encryption Security Policy: {encryption_security_policy_name}"

        self.cfn_encryption_security_policy = opensearch_serverless.CfnSecurityPolicy(self, "EncryptionSecurityPolicy",
        ...
        self.cfn_collection = opensearch_serverless.CfnCollection(self, "OpssSearchCollection",
        ...
        self.cfn_access_policy = opensearch_serverless.CfnAccessPolicy(self, "OpssDataAccessPolicy",
