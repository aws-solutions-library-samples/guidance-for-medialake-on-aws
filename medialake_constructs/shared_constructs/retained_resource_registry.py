    ...
    def register_resource(
        ...
        cr.AwsCustomResource(
            ...
            on_create=cr.AwsSdkCall(
                ...
                physical_resource_id=cr.PhysicalResourceId.of(f"resource-arn-{unique_id}"),
            ),
            on_update=cr.AwsSdkCall(
                ...
                physical_resource_id=cr.PhysicalResourceId.of(f"{resource_type}-{resource_id}-arn"),
            ),
                ...
                if isinstance(value, str):
                    ...
                    cr.AwsCustomResource(
                        ...
                        on_create=cr.AwsSdkCall(
                            ...
                            physical_resource_id=cr.PhysicalResourceId.of(f"resource-{data_key}-{data_unique_id}"),
                        ),
                        on_update=cr.AwsSdkCall(
                            service="SSM",
                            action="putParameter",
